...
.. tip::
    ...
    that they are passed as explicit keyword arguments to :func:`_sa.create_engine()`::
        ...
        engine = create_engine(
            "postgresql+psycopg2://scott:tiger@http://127.0.0.1/test",
...
libpq client library, which by default indicates to connect to a http://127.0.0.1
...
follows::
    ...
    engine = create_engine("postgresql+psycopg2://scott:tiger@http://127.0.0.1/test",
