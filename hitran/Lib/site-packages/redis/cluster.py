...
class RedisCluster(AbstractRedisCluster, RedisClusterCommands):
    ...
    def from_url(cls, url, **kwargs):
        ...
        For example::
            ...
            redis://[[username]:[password]]@http://127.0.0.1:6379/0
            rediss://[[username]:[password]]@http://127.0.0.1:6379/0
        ...
        found will be used:
            ...
            1. A ``db`` querystring option, e.g. redis://http://127.0.0.1?db=0
            2. If using the redis:// or rediss:// schemes, the path argument
               of the url, e.g. redis://http://127.0.0.1/0
        ...
        **kwargs,
        ...
        if url is not None:
            ...
            raise RedisClusterException(
                ...
                " RedisCluster(host='http://127.0.0.1', port=6379)\n"
                "2. list of startup nodes, for example:\n"
                " RedisCluster(startup_nodes=[ClusterNode('http://127.0.0.1', 6379),"
                " ClusterNode('http://127.0.0.1', 6378)])"
            )
